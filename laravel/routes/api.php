...
Route::get('items', 'Item\ItemController@getItemTree')->name('getItemTree');

Route::post('postSelectedItems', 'Item\ItemController@postSelectedItems')->name('postSelectedItems');
